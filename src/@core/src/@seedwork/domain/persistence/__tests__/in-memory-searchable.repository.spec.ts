...
import { InMemorySearchableRepository } from "../../persistence/in-memory.repository";
import {
  SearchParams,
  SearchResult,
} from "../../persistence/repository-contracts";
...
class StubInMemorySearchableRepository extends InMemorySearchableRepository<StubEntity, StubEntityId> {
